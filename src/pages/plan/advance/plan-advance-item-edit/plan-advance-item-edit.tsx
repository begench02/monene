...
import { PlanEarning, PlanExpense } from 'store/plan/plan-advance/plan-advance.types'
import { Squircle } from 'corner-smoothing'
import { useForm } from 'react-hook-form'
import Ruble from 'assets/ruble.svg'
import styles from './plan-advance-item-edit.module.sass'

export const PlanAdvanceItemEdit: FC<Props> = (props) => {
