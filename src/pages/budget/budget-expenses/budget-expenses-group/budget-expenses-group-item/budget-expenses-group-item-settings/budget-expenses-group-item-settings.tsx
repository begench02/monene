	...
	return (
		<div className={styles.main}>
			...
			<div
				className={styles.content_item}
				onClick={() => {
					dispatch(budgetExpensesGroupItemMoveUp({ id: groupId, name }))
					close()
				}}
			>
			...
			<div
				className={styles.content_item}
				onClick={() => {
					dispatch(budgetExpensesGroupItemMoveDown({ id: groupId, name }))
					close()
				}}
			>
				...
				<div className={styles.delete_main}>
					...
					<div className={styles.delete_buttons}>
						<div
							...
							onClick={() => {
								dispatch(budgetExpensesGroupItemDelete({ groupId, name }))
								close()
							}}
						>
							<p>Да</p>
